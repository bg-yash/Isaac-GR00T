...
class P2DataConfig(BaseDataConfig):
    video_keys = ["video.hfg_left", "video.hfg_right"]
    state_keys = ["state.ee_pos", "state.ee_rot", "state.wrist"]
    action_keys = ["action.ee_pos", "action.ee_rot", "action.valve"]
    # language_keys = ["annotation.human.task_description"]
    observation_indices = [0]
    action_indices = list(range(16))
